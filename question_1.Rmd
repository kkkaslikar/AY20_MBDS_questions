...
$$
total\_distance = rightward\_distance + downward\_distance \\

\therefore downward\_distance = total\_distance - rightward\_distance
$$
...
```{r}
for(i in seq_along(all.distances)){
  line <- paste(all.distances[i], solution.strings[i], sep = " ")
  write_lines(x = line, path = "./Question 1/output_question_1.txt", sep = "\n", append = TRUE)
}
```
...
This question has been solved a little differently, owing to the fact that using the current code, the first of the summed numbers `87,127,231,192`, cannot be reached within the required of operations.
...
write_lines(x = "", path = "./Question 1/output_question_1.txt", sep = "\n", append = TRUE)
