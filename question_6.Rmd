...
To get the coordinates of the intersection point of the one of the lines of the polygon with the vertical line $x = a$, we would have to substitute $x = a$ in the equation of that line of the polygon.

Similarly, the coordinates of the intersection point of the one of the lines of the polygon with the horizontal line $y = b$, we would have to substitute $y = b$ in the equation of that line of the polygon.
